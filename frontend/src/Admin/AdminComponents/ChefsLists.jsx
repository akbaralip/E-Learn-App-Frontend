...
function ChefsLists() {
  ...
  const handleUnblockUser = async (userId) => {
    ...
    try {
      ...
      // Fetch updated users after unblocking
      fetchUsers();
    } catch (error) {
  ...
  return (
    <div>
      ...
      <div className="relative overflow-x-auto p-14 bg-gray-200 ">
        <h1 className="text-2xl font-bold mb-6">All Chefs Details</h1>
              ...
              <tr key={index} className="bg-white dark:bg-gray-800">
                ...
                <td className="px-6 py-4">
                  {user.is_active ? (
                    ...
                    >
                      {loading ? <i className="pi pi-spin pi-spinner" style={{ fontSize: '1rem' }}></i> : "Block"}
                    ...
                    <button
                      ...
                      disabled={loading}
                    >
                      {loading ? <i className="pi pi-spin pi-spinner" style={{ fontSize: '1rem' }}></i> : "Unblock"}
                    </button>
                  )}
                </td>
              </tr>
